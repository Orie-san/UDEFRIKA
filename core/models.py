...
class Category(models.Model):
    ...
    title = models.CharField(max_length=100, default="Development")
...
class Vendor(models.Model):
    ...
    title = models.CharField(max_length=100, default="Dr. Auriel")
    image = models.CharField(max_length=2000)
    url = models.CharField(max_length=2000, default="https://www.udemy.com/")
    ...
    job_title = models.CharField(max_length=2000, default="Instructor")
    #contact = models.CharField(max_length=2000)
    # authentic_rating = models.CharField(max_length=100, default="100")
    days_return = models.CharField(max_length=100, default="30")
    warranty_period = models.CharField(max_length=100, default="Illimited")
