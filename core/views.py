...
from core.models import Product, Category, Vendor, CartOrder, CartOrderProducts, ProductReview, \
    wishlist_model, Address
...
def product_detail_view(request, pid):
    ...
    if request.user.is_authenticated:
        ...
        try:
            address = Address.objects.get(status=True, user_id=request.user.id)
        except:
            pass
...
def customer_dashboard(request):
    ...
    orders = CartOrder.objects.annotate(month=ExtractMonth("order_date")).values("month").annotate(
